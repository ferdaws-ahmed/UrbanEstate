  ...
  return (
    <section
      className={`w-full py-24 px-6 lg:px-12 ${
        isDark
          ? "bg-gradient-to-b from-[#0a2e26] to-[#061510]"
          : "bg-gradient-to-b from-white to-[#f0f8f0]"
    ...
    >
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Micro-Climate
            <span className="text-[#cddfa0] italic font-light"> Scanner</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4 space-y-6">
            <p
              ...
              } text-[10px] font-bold tracking-[0.3em] uppercase mb-4`}
            >
                  ...
                  className={`flex items-center justify-between p-5 rounded-2xl border transition-all duration-500 text-left group ${
                    activeMode.id === mode.id
                      ...
                      : `${isDark ? "bg-white/[0.03]" : "bg-black/[0.03]"} ${
                          isDark
                            ? "border-white/10 hover:border-[#cddfa0]/50"
                            : "border-[#0f2e28]/10 hover:border-[#cddfa0]/50"
                        }`
                  }`}
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`p-2 rounded-lg transition-colors ${
                        activeMode.id === mode.id
                          ? isDark
                            ? "bg-[#061510] text-[#cddfa0]"
                            : "bg-white text-[#0f2e28]"
                          : isDark
                          ? "bg-white/10 text-[#cddfa0]"
                          : "bg-black/10 text-[#0f2e28]"
                      }`}
                    >
                      {mode.icon}
                    </div>
            ...
            <div className="bg-[#0a231f]/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 relative overflow-hidden shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                {Object.entries(activeMode.data).map(([key, value]) => (
                  ...
                  >
                    <p className="text-[#cddfa0]/40 text-[8px] uppercase font-black mb-1">
                      {key}
                    </p>
          ...
          <div className="lg:col-span-8 relative aspect-video lg:aspect-auto h-[450px] lg:h-[650px] rounded-[3rem] overflow-hidden border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.4)] bg-[#040f0c] group">
            ...
            <div className="absolute inset-0 z-20 pointer-events-none">
              ...
              <div className="absolute top-8 left-10 flex flex-col gap-1">
                <span className="text-[#cddfa0] font-mono text-[10px] tracking-[0.2em] uppercase drop-shadow-md">
                  Status: Analyzing Environment
                </span>
                <span className="text-white/40 font-mono text-[8px] uppercase tracking-tighter italic">
                ...
                {activeMode.id === "wind" && (
                  <div className="grid grid-cols-6 gap-20 opacity-30">
                    {[...Array(12)].map((_, i) => (
                      <ArrowUpRight
                        key={i}
                        className="text-[#cddfa0] animate-bounce"
                ...
                {activeMode.id === "stability" && (
                  <div className="relative">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                      <ShieldCheck
                        size={80}
                        className="text-[#cddfa0] opacity-80 drop-shadow-[0_0_15px_#cddfa0]"
                        strokeWidth={1}
                      />
                    </div>
                  </div>
