  ...
  return (
    <>
        ...
        <Marker position={userLocation} icon={pulseIcon}>
          <Popup>
            <div className="font-bold text-white text-base flex items-center gap-2">
              <Navigation size={16} className="text-[#ef4444]" /> Your Current
              Location
            </div>
        ...
        crimeAreas.map((c) => (
          <Polygon
            ...
            pathOptions={{
              color: "#10b981",
              fillColor: "#10b981",
              fillOpacity: 0.25 * c.safetyScore,
              weight: 2,
            }}
          >
            <Popup>
      ...
      {showAQI &&
        aqiAreas.map((a) => {
          const color =
            a.aqi > 150 ? "#ef4444" : a.aqi > 100 ? "#facc15" : "#10b981";
          return (
            <Polygon
              key={`aqi-${a.id}`}
              positions={a.polygon}
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          >
            ...
            our interactive data overlays to make the best real estate decision.
          </p>
        </div>
        ...
        >
          <div
            className={`lg:col-span-8 h-[500px] lg:h-[650px] relative z-0 border-r ${
              isDark ? "border-white/10" : "border-black/10"
            }`}
          >
            <MapContainer
          ...
          <div
            className={`lg:col-span-4 p-8 lg:p-10 flex flex-col justify-between ${
              isDark ? "bg-white/5" : "bg-black/5"
            } z-10`}
          >
            <div>
            ...
            <div className="mt-10 pt-6 border-t border-white/10">
              ...
              <div className={`grid grid-cols-2 gap-4 text-xs ${isDark ? "text-white/70":"text-black/70"} font-medium`}>
                <div className="flex items-center gap-3">
                  <span className="w-3 h-3 bg-[#ef4444] rounded-full shadow-[0_0_10px_#ef4444]" />{" "}
                  High Noise
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  <span className="w-3 h-3 bg-[#ef4444] rounded-full shadow-[0_0_10px_#ef4444] animate-pulse border border-white" />{" "}
                  Live Location
                </div>
                <div className="flex items-center gap-3">
                  <span className="w-3 h-3 bg-[#b91c1c] rounded-full shadow-[0_0_10px_#b91c1c]" />{" "}
                  Poor AQI
                </div>
              </div>
            </div>
