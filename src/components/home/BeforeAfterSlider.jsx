...
export default function FuturisticAIStaging() {
  ...
  useEffect(() => {
    const handlePointerMove = (e) => {
      ...
      if (dataTextRef.current) {
        dataTextRef.current.innerText = `SCAN DATA // X: ${Math.round(
          x
        )} Y: ${Math.round(y)}`;
      }
    };
  ...
  const beforeImg =
    "https://images.unsplash.com/photo-1513694203232-719a280e022f?q=80&w=1600&auto=format&fit=crop"; // Empty room
  const afterImg =
    "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?q=80&w=1600&auto=format&fit=crop"; // Staged room
      ...
      <div className="container mx-auto max-w-6xl relative z-10 ">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          <div
            ...
            } mb-6 shadow-[0_0_20px_rgba(205,223,160,0.1)]`}
          >
          ...
          >
            ...
            fully furnished potential of any raw space.
          </p>
        </div>
