    ...
    <button
      ...
      className={`w-full flex items-center justify-between p-4 rounded-2xl border transition-all duration-300 ${
        activeTab === id 
          ...
          : (isDark ? 'bg-[#133c34]/40 border-[#1a4a40] text-gray-400 hover:bg-[#1a4a40]' : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50')
      }`}
    >
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={`w-full pl-16 pr-8 py-5 rounded-[2rem] border outline-none transition-all text-sm ${
                  isDark ? 'bg-[#0b1f1a] border-[#1a4a40] focus:border-emerald-500' : 'bg-white border-white text-gray-900 shadow-2xl shadow-black/20 focus:shadow-emerald-500/20'
                }`}
              />
            </div>
          </div>
