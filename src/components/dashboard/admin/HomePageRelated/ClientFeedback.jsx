...
export default function ClientFeedback({ feedback }) {
  const { isDark } = useTheme();


  const defaultFeedback = [
    { id: 1, client: "Mr. Rahman", time: "2 hours ago", property: "Luxury Villa #APT-402", comment: "Excellent service and smooth paperwork. Highly recommended!", rating: 5 },
    { id: 2, client: "Sarah Ahmed", time: "1 day ago", property: "Commercial Space #PR-102", comment: "The agent was very professional and helped us find the perfect office.", rating: 5 },
    { id: 3, client: "Dr. Kabir", time: "3 days ago", property: "Land Plot #L-99", comment: "Transparent dealing. Everything was clear from day one. Great experience.", rating: 4 },
    { id: 4, client: "Nusrat Jahan", time: "1 week ago", property: "Duplex #DP-05", comment: "Loved the property tour. Very accommodating staff and prompt response.", rating: 5 },
    { id: 5, client: "Tanvir Hasan", time: "2 weeks ago", property: "Studio Apartment #S-12", comment: "Fast response time and very helpful in negotiating the price.", rating: 4 },
    { id: 6, client: "Farzana Akter", time: "1 month ago", property: "Retail Space #RS-08", comment: "They found the exact location I needed for my new boutique.", rating: 5 },
  ];
      ...
      <div className="flex justify-between items-start mb-4 relative z-10 shrink-0 gap-2">
        <div className="min-w-0 flex-1">
          <h3 className={`text-[13px] sm:text-base font-black flex items-center gap-1.5 flex-wrap ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>
            ...
            Client <span className={isDark ? 'text-[#cddfa0]' : 'text-blue-600'}>Feedback</span>
          </h3>
