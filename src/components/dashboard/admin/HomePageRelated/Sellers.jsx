    ...
    <div className="min-h-screen bg-gray-50">   
      <div className="p-6 overflow-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">Monitor and manage real estate Sellers</p>
        </div>
              ...
              <tbody>
                {filteredSellers.map((Seller) => (
                  <tr key={Seller.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-gray-700">{Seller.email}</td>
                    <td className="py-3 px-4 text-gray-700">{Seller.phone}</td>
                    <td className="py-3 px-4 text-gray-700">{Seller.properties}</td>
                    <td className="py-3 px-4 text-gray-700 font-semibold">{Seller.sales}</td>
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            ...
            <p className="text-2xl font-bold text-gray-900 mt-2">{SellersData.length}</p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            <h3 className="text-sm font-medium text-gray-600">Active Sellers</h3>
            <p className="text-2xl font-bold text-gray-900 mt-2">
              {SellersData.filter(a => a.status === 'Active').length}
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200">
