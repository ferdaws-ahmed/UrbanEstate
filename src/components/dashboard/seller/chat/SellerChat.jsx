              ...
              >
                <div className="relative shrink-0">
                  ...
                  {contact.unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 w-5 h-5 bg-teal-600 text-white text-[10px] font-black rounded-full flex items-center justify-center border-2 border-[#0b1f1a]">
                      {contact.unreadCount}
                    </span>
                  )}
                </div>
