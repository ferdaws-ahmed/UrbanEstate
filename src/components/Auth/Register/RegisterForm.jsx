        ...
        <div className="w-full md:w-1/2 p-6 sm:p-10 lg:p-14 flex flex-col justify-center bg-white dark:bg-slate-900">
          ...
          <div className="mt-10">
            <div className="relative flex items-center justify-center mb-8">
              ...
              <span className="absolute px-6 bg-white dark:bg-slate-900 text-[10px] text-slate-400 uppercase tracking-[0.2em] font-bold">
                Quick connect with
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="flex items-center justify-center gap-3 py-4 border border-slate-100 dark:border-slate-800 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-all font-bold text-slate-700 dark:text-white text-sm group"
              >
                <Chrome
                  size={20}
