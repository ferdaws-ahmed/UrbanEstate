  ...
  return (
    <>
      ...
      <nav
        ...
        ${scrolled ? "bg-[#0f2e28]/20 backdrop-blur-lg py-3 shadow-[0_4px_30px_rgba(0,0,0,0.1)]" : "bg-transparent py-6"}`}
      >
        ...
        <div className={`fixed top-0 right-0 h-screen w-full sm:w-80 bg-[#0f2e28]/30 backdrop-blur-xl border-l border-white/20 z-[105] transform transition-transform duration-500 ease-in-out lg:hidden
          ...
          <div className="flex flex-col h-full p-10 justify-center relative">
            ...
            <div className="flex flex-col gap-4 mt-12 pt-10 border-t border-white/10">
              ...
              <Translation isMobile={true} closeMenu={() => setIsMenuOpen(false)} />

              {!user ? (
                <>
                  <Link href="/login" onClick={() => setIsMenuOpen(false)} className="text-[#cddfa0] text-center font-bold text-xl py-3 border border-[#cddfa0]/30 rounded-xl mt-2">
                    Get Started
                  </Link>
                ...
                <>
                  <Link href="/profile" onClick={() => setIsMenuOpen(false)} className="text-[#cddfa0] text-center font-bold text-xl py-3 border border-[#cddfa0]/30 rounded-xl mt-2">
                    My Profile
                  </Link>
                  <button 
